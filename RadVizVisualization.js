...
/*Radviz function to create the data visualization Referred from:  //https://github.com/WYanChao/RadViz  */
function RadViz() {
    ...
    function RV(div) {
        ...
        /* Main Function to display Radviz Referred from:  //https://github.com/WYanChao/RadViz */
        function RVradviz() {
            function chart(div) {
                div.each(function() {
                    ...
                    tooltip.append('text').attr('width', 150).attr('height', 25).attr('x', 5).attr('y', function(d, i) {
                        ...
                        .text(d => d + ':').attr('text-anchor', 'start').attr('dominat-baseline', 'hanging').style('font-size', "19px").style("font-weight", 900).style("fill", "rgb(25,25,112)");

                    /* Plotting the node and the legend*/
                    drawDT();
                    drawLegend();

                    /* Function to create the parent circle*/
                    ...
                    /* Function to create the Panel for each node */
                    function drawDA() {
                    ...
                    /* Function to update the nodes on the basis of anchors*/
                    ...
                    /* Function to draw labels for the data*/
                    ...
                    /* Function to create the data points of the dataset*/
                    function drawDT() {
        ...
        /* Function to calculate the node position*/
        ...
        /* Function to normaliz the data and addition */
